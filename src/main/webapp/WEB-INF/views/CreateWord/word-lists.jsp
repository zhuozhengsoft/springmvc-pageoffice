...
<head>
    <title></title>
    <link href="../../css/CreateWord/style.css" rel="stylesheet" type="text/css"/>
...
<div class="zz-headBox br-5 clearfix">
    <div class="zz-head mc">
        ...
        <div class="logo fl">
            <a href="home.html">
                <img src="../../css/CreateWord/logo.png" alt=""/></a></div>
        <!--logo end-->
...
<div class="zz-content mc clearfix pd-28">
    ...
    <div class="demo mc" style="text-align:left;">
        <h3 class="fs-12">
            新建文件</h3>
        <form id="form1" method="post" action="CopyCreatWord?op=create">
            <table class="text" cellspacing="0" cellpadding="0" border="0">
                ...
                <tr>
                    ...
                    <td>
                        &nbsp;<a
                            href="javascript:POBrowser.openWindowModeless('CreateWord' , 'width=1200px;height=800px;')"
