...
<html>
    ...
    <script type="text/javascript">
        ...
        function getID() {
            ...
            //第一次自刷新
            document.getElementById("iframe1").src = "Convert?id=" + str[count];
            //设置进度条
