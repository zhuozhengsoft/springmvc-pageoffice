...
@Controller
@RequestMapping("WordCreateTable")
public class WordCreateTableController {
    ...
    public ModelAndView openWord(HttpServletRequest request, Map<String, Object> map) throws Exception{
        ...
        //打开Word文档
        poCtrl.webOpen("/doc/WordCreateTable/createTable.doc", OpenModeType.docNormalEdit, "张三");
        map.put("pageoffice", poCtrl.getHtmlCode("PageOfficeCtrl1"));
        ModelAndView mv = new ModelAndView("WordCreateTable/createTable");
        return mv;
    }
}
