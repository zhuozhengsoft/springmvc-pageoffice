...
@Controller
@RequestMapping("SetExcelCellText")
public class SetExcelCellTextController {
    ...
    public ModelAndView openExcel(HttpServletRequest request, Map<String, Object> map) throws Exception{
        ...
        //设置文档打开方式
        poCtrl.webOpen("/doc/SetExcelCellText/test.xls", OpenModeType.xlsNormalEdit, "李斯");
        map.put("pageoffice", poCtrl.getHtmlCode("PageOfficeCtrl1"));
        ModelAndView mv = new ModelAndView("SetExcelCellText/Default");
        return mv;
    }
