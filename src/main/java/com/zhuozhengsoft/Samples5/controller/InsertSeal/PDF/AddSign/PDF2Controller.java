package com.zhuozhengsoft.Samples5.controller.InsertSeal.PDF.AddSign;
...
@Controller
@RequestMapping("InsertSeal/PDF/AddSign1")
public class PDF2Controller {
    ...
    public ModelAndView openWord(HttpServletRequest request, Map<String, Object> map) throws Exception{
        ...
        pdfCtrl.webOpen("/doc/InsertSeal/PDF/AddSign1/test.pdf");
        //打开Word文档
        map.put("pageoffice", pdfCtrl.getHtmlCode("PDFCtrl1"));
        ModelAndView mv = new ModelAndView("InsertSeal/PDF/AddSign1/PDF2");
        return mv;
    }
    ...
    public void AddSeal6Word6Save(HttpServletRequest request, HttpServletResponse response) throws Exception{
        ...
        fs.saveToFile(request.getSession().getServletContext().getRealPath("doc/InsertSeal/PDF/AddSign1/")+fs.getFileName());
        fs.close();
    }
}
